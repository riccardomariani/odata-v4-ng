    ...
    it('test properties', () => {
          ...
          <edmx:DataServices>
            <Schema Namespace="namespace">
                <EntityType Name="name">
                    ...
                    <Property Name="name" Type="type" Nullable="true" MaxLength="1" Precision="2" Scale="3" Unicode="false" SRID="4" DefaultValue="defaultValue"/>
                </EntityType>
                <EntityContainer></EntityContainer>
            </Schema>
          </edmx:DataServices>
        ...
        expect(schema.entityTypes).toEqual([
            new CsdlEntityType('name', undefined, [
                new CsdlProperty('name', 'type'),
                new CsdlProperty('name', 'type', true, 1, 2, 3, false, '4', 'defaultValue')
            ])
        ]);
