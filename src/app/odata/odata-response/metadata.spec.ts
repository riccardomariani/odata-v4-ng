...
describe('Metadata', () => {
    ...
    const schemas: CsdlSchema[] = metadata.getSchemas();

    it('test namespace', () => {
        expect(schemas.length).toEqual(1);
        const schema: CsdlSchema = schemas[0];
        expect(schema.namespace).toEqual('Microsoft.OData.SampleService.Models.TripPin');
    });
    ...
    it('test complexTypes', () => {
        ...
        expect(schema.complexTypes).toEqual([
            ...
            new CsdlComplexType('AirportLocation', [
                new CsdlProperty('Loc', 'Edm.GeographyPoint', false, 4326)
            ], 'Microsoft.OData.SampleService.Models.TripPin.Location', true)
        ]);
    });
        ...
        expect(schema.entityTypes).toEqual([
            ...
            new CsdlEntityType('Person', new CsdlKey([new CsdlPropertyRef('UserName')]), [
                ...
                new CsdlProperty('Concurrency', 'Edm.Int64', false),
                    ...
                    new CsdlNavigationProperty('Trips', 'Collection(Microsoft.OData.SampleService.Models.TripPin.Trip)', undefined, true),
            ...
            new CsdlEntityType('Trip', new CsdlKey([new CsdlPropertyRef('TripId')]), [
                ...
                new CsdlProperty('Tags', 'Collection(Edm.String)', false),
                    ...
                    new CsdlNavigationProperty('PlanItems', 'Collection(Microsoft.OData.SampleService.Models.TripPin.PlanItem)', undefined, true),
                ])
        ]);
    });
